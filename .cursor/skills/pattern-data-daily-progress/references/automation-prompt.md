...
4. Update all report sections per the skill template (no Standup action items section). Recompute Path to UAT N/M. Put follow-ups in tracker Next step, Status at a glance, or Risks mitigations.
