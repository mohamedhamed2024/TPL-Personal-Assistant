...
**Feature:** [DVI-1086](https://datavant.atlassian.net/browse/DVI-1086) · **As of:** 2026-09-16  
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| **PD Sandbox finalize** | Team | In progress | <ul><li><strong>Jira sync 2026-09-16:</strong> 9 open stories still In Progress — no story status or assignee change since 2026-09-10</li><li><strong>Jira 2026-09-16 (morning):</strong> Sarah opened [LNI-5342](https://datavant.atlassian.net/browse/LNI-5342) Deployment Activities under SSO [LNI-3224](https://datavant.atlassian.net/browse/LNI-3224) — In Progress (deployment calls)</li></ul> | <ul><li>Apply Code V13 + Rollback V2 test classes; land the dedicated Payment Transaction visibility flag</li><li>Finish UAT org config / Pattern Data accounts if still incomplete (Michael)</li><li>SSO deployment activities ([LNI-5342](https://datavant.atlassian.net/browse/LNI-5342)) — Sarah</li><li>Client approval on <strong>4 BLOCKING</strong> consent wordings</li></ul> | Rolling | — | Morning Jira-only run. No standup or Austin-class transcript for <strong>2026-09-11</strong> through <strong>2026-09-16</strong>. Last standup was <strong>2026-09-10</strong> (holiday / thin staffing) |
...
| 2 | **UAT config + smoke + test** | UAT | Austin short huddle (2026-09-09): **ready, have a plan, will deploy**. Last standup asked Hamed + Islam to start testing; no new standup since then to confirm completion. **Jira 2026-09-16:** Sarah In Progress on SSO [LNI-5342](https://datavant.atlassian.net/browse/LNI-5342) Deployment Activities |
...
*Last Austin input:* [PD Review with Austin — 2026-09-06](../Transcript/PDReviewWithAustin/PDReviewWithAustin-2026-09-06) — transcript has a **timestamp jump** (~0:57 → ~1:19:22); middle not captured. No PD Review, Austin meeting, or ChartSwap standup `.docx` for **2026-09-11** through **2026-09-16**. Day-to-day last captured from [ChartSwap Daily Stand-up — 2026-09-10](../Transcript/ChartSwap%20Daily%20Stand%20up/ChartSwap-Daily-Stand-up-2026-09-10.docx). Jira backfill: [LNI-3224](https://datavant.atlassian.net/browse/LNI-3224) subtask [LNI-5342](https://datavant.atlassian.net/browse/LNI-5342) created **2026-09-16** (Sarah, Deployment Activities); [LNI-3137](https://datavant.atlassian.net/browse/LNI-3137) Luis comment **2026-09-14** (Code V13 deployment test classes), Austin comment **2026-09-13** (Rollback V2 test classes), plus [LNI-3223](https://datavant.atlassian.net/browse/LNI-3223) *Austin requirement sync — 2026-09-10* (`Call / source:` Call with Austin Moss (4)) and the earlier *Austin requirement sync — 2026-09-08*. **Baseline from Jira sync 2026-09-16.**

---

## Feature delivery tracker

*Synced from [DVI-1086](https://datavant.atlassian.net/browse/DVI-1086) on 2026-09-16 (live).*
...
| **Sarah** | [LNI-3224](https://datavant.atlassian.net/browse/LNI-3224) SAML SSO PR #193; **[LNI-5342](https://datavant.atlassian.net/browse/LNI-5342) Deployment Activities** (In Progress, opened 2026-09-16); [LNI-3763](https://datavant.atlassian.net/browse/LNI-3763) RequestShare (PR #256 / #253) |
...
| --- | --- | --- | --- |
| 1 | **Islam cannot log defects or update Jira.** Islam has no Jira account — QA progress is invisible in the tracker and defects may be tracked only in standup or chat. Datavant IT said **HR approval** is required; Austin's follow-up with Datavant HR/IT is inconsistent. | <ul><li>No standup 2026-09-11–16 to confirm whether UAT testing continued</li><li>**Hamed / Nabawy** keep following Austin and the IT security-group request (still open **2026-09-16**)</li></ul> | Medium |
