...
**Go-live goal:** End of June 2026 · **Epic:** [OC-9223](https://ontellus.atlassian.net/browse/OC-9223) · **As of:** 2026-06-07
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| **Pre-UAT** | Youssef | In progress | <li>4/7 providers tested [STD, PFP, RR, and Waystar]</li><li>RR payment bugs cleared — end-to-end retest scheduled</li><li>CIOX sandbox testing in progress (Hamed; pre-fulfillment parity with UAT)</li><li>Updox + ShareCare sandbox testing started (2026-06-07; Michael)</li> | <ul><li>[OC-9532](https://ontellus.atlassian.net/browse/OC-9532) — pending client decision; PD channel escalation</li><li>Test Updox and ShareCare on PD sandbox (Michael); Hamed reviewing provider list</li><li>Youssef — full Record Retrieval flow retest (2026-06-08)</li></ul> | 2026-05-21 | **2026-06-14** | <li>Sandbox goal: **pre-fulfillment parity with UAT** — not chasing fulfillment simulation on sandbox. CIOX fulfillment gap accepted per 06-05 agreement; escalate only if new non-fulfillment issues surface (see [OC-9532](#ciox--oc-9532-pending-client-decision)).</li><li>External-provider fulfillment simulation deferred to UAT (Eric).</li><li>Automation paused — manual retest for now.</li> |
...
*Synced from Jira epic [OC-9223](https://ontellus.atlassian.net/browse/OC-9223) on 2026-06-07 (live; re-checked for new bugs).*

### CIOX

| Bug | What's wrong | Jira status | Assignee | Notes |
| --- | --- | --- | --- | --- |
| [OC-9532](https://ontellus.atlassian.net/browse/OC-9532) | Request marked Completed after 2nd payment without processing (manual fulfillment / provider portal path) | **Blocked** | Sara Hassan | **Update 2026-06-04:** Agreed with Austin & Van to hold external-provider fulfillment simulation on PD sandbox; defer to UAT (Eric). **Update 2026-06-07:** Hamed testing CIOX on sandbox against UAT pre-fulfillment state; team proceeding unless new non-fulfillment issues surface |
| [OC-9552](https://ontellus.atlassian.net/browse/OC-9552) | Request Fee duplicated in Payment Received after 1st AutoPay payment (charged $74 instead of $37) | **QA** | Mohamed Hamed | **New 2026-06-07** — found during CIOX sandbox testing (Hamed); Major — customer overcharged on 1st payment |
