...
**Feature:** [DVI-1086](https://datavant.atlassian.net/browse/DVI-1086) · **As of:** 2026-09-17  
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| **PD Sandbox finalize** | Team | In progress | <ul><li><strong>Jira sync 2026-09-17:</strong> 9 open stories still In Progress — no story status or assignee change since 2026-09-10</li><li><strong>Jira 2026-09-17 (morning):</strong> Sarah logged +1h on SSO [LNI-5342](https://datavant.atlassian.net/browse/LNI-5342) Deployment Activities (still In Progress; ~11h total). Ticket still has the 2026-09-16 attachment <em>LNI-3224_LNI-3763_Deployment_Guide_SSO_RequestShare_ChangeSet.pdf</em></li></ul> | <ul><li>Apply Code V13 + Rollback V2 test classes; land the dedicated Payment Transaction visibility flag</li><li>Finish UAT org config / Pattern Data accounts if still incomplete (Michael)</li><li>SSO / RequestShare deploy-package work ([LNI-5342](https://datavant.atlassian.net/browse/LNI-5342)) — Sarah</li><li>Client approval on <strong>4 BLOCKING</strong> consent wordings</li></ul> | Rolling | — | Morning Jira-only run. No standup or Austin-class transcript for <strong>2026-09-11</strong> through <strong>2026-09-17</strong>. Last standup was <strong>2026-09-10</strong> (holiday / thin staffing) |
...
| 2 | **UAT config + smoke + test** | UAT | Austin short huddle (2026-09-09): **ready, have a plan, will deploy**. Last standup asked Hamed + Islam to start testing; no new standup since then to confirm completion. **Jira 2026-09-17:** Sarah still In Progress on SSO [LNI-5342](https://datavant.atlassian.net/browse/LNI-5342) Deployment Activities (+1h worklog this morning; SSO/RequestShare changeset guide attached 2026-09-16) |
...
*Last Austin input:* [PD Review with Austin — 2026-09-06](../Transcript/PDReviewWithAustin/PDReviewWithAustin-2026-09-06) — transcript has a **timestamp jump** (~0:57 → ~1:19:22); middle not captured. No PD Review, Austin meeting, or ChartSwap standup `.docx` for **2026-09-11** through **2026-09-17**. Day-to-day last captured from [ChartSwap Daily Stand-up — 2026-09-10](../Transcript/ChartSwap%20Daily%20Stand%20up/ChartSwap-Daily-Stand-up-2026-09-10.docx). Jira backfill: [LNI-3224](https://datavant.atlassian.net/browse/LNI-3224) subtask [LNI-5342](https://datavant.atlassian.net/browse/LNI-5342) worklog **2026-09-17** (Sarah, +1h; description cleared); attachment **2026-09-16** (`LNI-3224_LNI-3763_Deployment_Guide_SSO_RequestShare_ChangeSet.pdf`); [LNI-3137](https://datavant.atlassian.net/browse/LNI-3137) Luis comment **2026-09-14** (Code V13 deployment test classes), Austin comment **2026-09-13** (Rollback V2 test classes), plus [LNI-3223](https://datavant.atlassian.net/browse/LNI-3223) *Austin requirement sync — 2026-09-10* (`Call / source:` Call with Austin Moss (4)) and the earlier *Austin requirement sync — 2026-09-08*. **Baseline from Jira sync 2026-09-17.**

---

## Feature delivery tracker

*Synced from [DVI-1086](https://datavant.atlassian.net/browse/DVI-1086) on 2026-09-17 (live).*
...
| **Sarah** | [LNI-3224](https://datavant.atlassian.net/browse/LNI-3224) SAML SSO PR #193; **[LNI-5342](https://datavant.atlassian.net/browse/LNI-5342) Deployment Activities** (In Progress; +1h 2026-09-17; SSO/RequestShare changeset guide PDF); [LNI-3763](https://datavant.atlassian.net/browse/LNI-3763) RequestShare (PR #256 / #253) |
...
| --- | --- | --- | --- |
| 1 | **Islam cannot log defects or update Jira.** Islam has no Jira account — QA progress is invisible in the tracker and defects may be tracked only in standup or chat. Datavant IT said **HR approval** is required; Austin's follow-up with Datavant HR/IT is inconsistent. | <ul><li>No standup 2026-09-11–17 to confirm whether UAT testing continued</li><li>**Hamed / Nabawy** keep following Austin and the IT security-group request (still open **2026-09-17**)</li></ul> | Medium |
