...
**Feature:** [DVI-1086](https://datavant.atlassian.net/browse/DVI-1086) · **As of:** 2026-09-14  
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| **PD Sandbox finalize** | Team | In progress | <ul><li><strong>Jira sync 2026-09-14:</strong> 9 open stories still In Progress — no status or assignee change since 2026-09-10</li><li><strong>Jira Austin 2026-09-13 (afternoon):</strong> posted Apex test class list for rollback package <strong>LNI-3137 Rollback V2</strong> on [LNI-3137](https://datavant.atlassian.net/browse/LNI-3137)</li></ul> | <ul><li>Apply Rollback V2 test classes; land the dedicated Payment Transaction visibility flag</li><li>Finish UAT org config / Pattern Data accounts if still incomplete (Michael)</li><li>Client approval on <strong>4 BLOCKING</strong> consent wordings</li></ul> | Rolling | — | Morning Jira-only run. No standup or Austin-class transcript for <strong>2026-09-11</strong> through <strong>2026-09-14</strong>. Last standup was <strong>2026-09-10</strong> (holiday / thin staffing) |
...
| **Production** | Team | Not started | — | <ul><li>UAT sign-off; production deploy packages per feature (same split journey Michael documented, plus Rollback V2 tests Austin listed)</li></ul> | **2026-09-08** | **2026-09-14** | Official Production date missed. Last Austin / standup working date is <strong>today (Monday 2026-09-14)</strong>. At risk: UAT still unsigned and no transcript this morning to confirm go/no-go |
...
| --- | --- | --- | --- |
| 1 | **Lost Payflow response / double-charge prevention** — [LNI-3137](https://datavant.atlassian.net/browse/LNI-3137) / [LNI-3223](https://datavant.atlassian.net/browse/LNI-3223) | UAT | **PD Review 2026-09-06** showstopper still in force. Packages on UAT (flow-dependency split). Last standup (2026-09-10): start UAT testing (business with Sarah; SSO separately). **Jira Austin 2026-09-13:** test class list for **LNI-3137 Rollback V2**. **Jira Austin sync 2026-09-10:** Payment Transaction view needs a **standalone account flag** (supersedes “no extra flag”). ChartSwap refresh-hold for BAU remains **after Pattern Data** |
...
| 3 | **Production** | Production | Last confirmed working date: **today (Monday 2026-09-14)**. Official target **2026-09-08** missed. Use the same package-split journey as UAT; include Rollback V2 tests Austin listed 2026-09-13 |
...
*Last Austin input:* [PD Review with Austin — 2026-09-06](../Transcript/PDReviewWithAustin/PDReviewWithAustin-2026-09-06) — transcript has a **timestamp jump** (~0:57 → ~1:19:22); middle not captured. No PD Review, Austin meeting, or ChartSwap standup `.docx` for **2026-09-11** through **2026-09-14**. Day-to-day last captured from [ChartSwap Daily Stand-up — 2026-09-10](../Transcript/ChartSwap%20Daily%20Stand%20up/ChartSwap-Daily-Stand-up-2026-09-10.docx). Jira backfill: [LNI-3137](https://datavant.atlassian.net/browse/LNI-3137) Austin comment **2026-09-13** (Rollback V2 test classes) plus [LNI-3223](https://datavant.atlassian.net/browse/LNI-3223) *Austin requirement sync — 2026-09-10* (`Call / source:` Call with Austin Moss (4)) and the earlier *Austin requirement sync — 2026-09-08*. **Baseline from Jira sync 2026-09-14.**

---

## Feature delivery tracker

*Synced from [DVI-1086](https://datavant.atlassian.net/browse/DVI-1086) on 2026-09-14 (live).*
...
| --- | --- | --- | --- |
| 1 | **Islam cannot log defects or update Jira.** Islam has no Jira account — QA progress is invisible in the tracker and defects may be tracked only in standup or chat. Datavant IT said **HR approval** is required; Austin's follow-up with Datavant HR/IT is inconsistent. | <ul><li>No standup 2026-09-11–14 to confirm whether UAT testing continued</li><li>**Hamed / Nabawy** keep following Austin and the IT security-group request (still open **2026-09-14**)</li></ul> | Medium |
...
| 3 | **Lost Payflow response can double-charge** — Austin showstopper. Official Production **2026-09-08** is missed; working date is **today (2026-09-14)** with UAT unsigned. Austin also added a dedicated Payment Transaction visibility flag (2026-09-10) and a Rollback V2 test list (2026-09-13) that must land before ship. | <ul><li>Confirm UAT smoke, Rollback V2 tests, and the new PT visibility flag before any production push</li><li>Reuse the flow-dependency package split for production</li><li>**Hamed / Nabawy** stay on Austin so scope does not reopen; working Production date is **Monday 2026-09-14** and is at risk without a go/no-go this morning</li></ul> | **High** |
