...
| --- | --- | --- | --- | --- | --- | --- | --- |
| **PD Sandbox finalize** | Team | In progress | <ul><li><strong>PD Review 2026-08-26:</strong> Austin — ready to <strong>start packaging</strong>; Michael to build deploy packages for <strong>all features</strong> (RequestShare included)</li><li>Provider-portal isolation confirmed; threshold, attachment, and after-completed fixes <strong>done</strong></li><li>PCI cart — <strong>functionally done</strong>; deploy <strong>independently</strong></li><li>Jira sync <strong>2026-09-03:</strong> 9 open stories unchanged; all still In Progress; new subtask [LNI-4978](https://datavant.atlassian.net/browse/LNI-4978) — Sarah resolving reviewer comments on RequestShare PRs #256, #253</li></ul> | <ul><li>Michael: consolidated <strong>3 deploy packages</strong> (settings/fields · code · rollback) — check-in with Austin per PD Review</li><li>Map feature dependencies; align with Van on request-sync upload ([LNI-3226](https://datavant.atlassian.net/browse/LNI-3226))</li><li>SSO production-credentials test answer for Austin; payment transaction flow doc</li><li>Client approval on <strong>4 BLOCKING</strong> consent wordings</li></ul> | Rolling | — | No standup or Austin-class transcript since <strong>2026-08-26</strong> (Thu <strong>2026-08-27</strong> holiday; Fri–Wed no transcript; <strong>2026-09-03</strong> morning Jira-only run) |
| **UAT Sandbox deploy** | Team | In progress | <ul><li>Epic [LNI-2309](https://datavant.atlassian.net/browse/LNI-2309) **UAT** in Jira; old Payment Management build in UAT — pddev is latest</li><li><strong>PD Review 2026-08-26:</strong> Michael <strong>cleared to start packaging</strong>; Luis can refresh UAT from master when Austin gives go-ahead</li></ul> | <ul><li>Finish package build on pddev; promote <strong>one consolidated push</strong> (or mapped smaller sets if dependency review allows)</li><li>Resolve what's in UAT — deploy or rollback before back-merge</li><li>PCI cart as separate deploy if scoped independently</li><li><strong>0/9</strong> features UAT-ready — packaging, PR merges, and wordings all block promotion</li></ul> | **2026-09-01** | **2026-09-01** | UAT target <strong>2026-09-01</strong> missed — milestone at risk; packaging, PR merges, and wordings still block promotion; no Jira story movement since <strong>2026-08-30</strong> |
| **Production** | Team | Not started | — | <ul><li>UAT sign-off; production deploy packages per feature</li></ul> | **2026-09-08** | **2026-09-08** | Live release after UAT sign-off per Austin; Production target <strong>5 days</strong> out with UAT not yet promoted |
...
| **Sarah** | [LNI-3224](https://datavant.atlassian.net/browse/LNI-3224) SSO PR #193; [LNI-3763](https://datavant.atlassian.net/browse/LNI-3763) RequestShare PRs #256, #253 — subtask [LNI-4978](https://datavant.atlassian.net/browse/LNI-4978) resolving reviewer comments; included in consolidated package — from Jira |
