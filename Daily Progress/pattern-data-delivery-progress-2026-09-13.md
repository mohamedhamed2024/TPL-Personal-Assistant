...
**Feature:** [DVI-1086](https://datavant.atlassian.net/browse/DVI-1086) · **As of:** 2026-09-13  
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| **PD Sandbox finalize** | Team | In progress | <ul><li><strong>Jira sync 2026-09-13:</strong> 9 open stories still In Progress — no status or assignee change since 2026-09-10</li><li><strong>Jira Austin sync 2026-09-10 (afternoon):</strong> Payment Transaction visibility needs its <strong>own account-level flag</strong> (separate from Save Payment Management) before ship — [LNI-3223](https://datavant.atlassian.net/browse/LNI-3223)</li></ul> | <ul><li>Land the dedicated Payment Transaction visibility flag</li><li>Finish UAT org config / Pattern Data accounts if still incomplete (Michael)</li><li>Client approval on <strong>4 BLOCKING</strong> consent wordings</li></ul> | Rolling | — | Morning Jira-only run. No standup or Austin-class transcript for <strong>2026-09-11</strong> through <strong>2026-09-13</strong> (Fri–Sun). Last standup was <strong>2026-09-10</strong> (holiday / thin staffing) |
...
| **Production** | Team | Not started | — | <ul><li>UAT sign-off; production deploy packages per feature (same split journey Michael documented)</li></ul> | **2026-09-08** | **2026-09-14** | Official Production date missed. Last Austin / standup working date is <strong>Monday 2026-09-14 (tomorrow)</strong> with UAT still unsigned |
...
| 3 | **Production** | Production | Last confirmed working date: **Monday 2026-09-14 (tomorrow)**. Official target **2026-09-08** missed. Use the same package-split journey as UAT |
...
*Last Austin input:* [PD Review with Austin — 2026-09-06](../Transcript/PDReviewWithAustin/PDReviewWithAustin-2026-09-06) — transcript has a **timestamp jump** (~0:57 → ~1:19:22); middle not captured. No PD Review, Austin meeting, or ChartSwap standup `.docx` for **2026-09-11** through **2026-09-13**. Day-to-day last captured from [ChartSwap Daily Stand-up — 2026-09-10](../Transcript/ChartSwap%20Daily%20Stand%20up/ChartSwap-Daily-Stand-up-2026-09-10.docx). Jira backfill: [LNI-3223](https://datavant.atlassian.net/browse/LNI-3223) *Austin requirement sync — 2026-09-10* (`Call / source:` Call with Austin Moss (4)) plus the earlier *Austin requirement sync — 2026-09-08*. **Baseline from Jira sync 2026-09-13.**

---

## Feature delivery tracker

*Synced from [DVI-1086](https://datavant.atlassian.net/browse/DVI-1086) on 2026-09-13 (live).*
...
| --- | --- | --- | --- |
| 1 | **Islam cannot log defects or update Jira.** Islam has no Jira account — QA progress is invisible in the tracker and defects may be tracked only in standup or chat. Datavant IT said **HR approval** is required; Austin's follow-up with Datavant HR/IT is inconsistent. | <ul><li>No standup 2026-09-11–13 to confirm whether UAT testing continued</li><li>**Hamed / Nabawy** keep following Austin and the IT security-group request (still open **2026-09-13**)</li></ul> | Medium |
...
| 3 | **Lost Payflow response can double-charge** — Austin showstopper. Official Production **2026-09-08** is missed; working date is **tomorrow (2026-09-14)** with UAT unsigned. Austin also added a dedicated Payment Transaction visibility flag (2026-09-10) that must land before ship. | <ul><li>Confirm UAT smoke and the new PT visibility flag before any production push</li><li>Reuse the flow-dependency package split for production</li><li>**Hamed / Nabawy** stay on Austin so scope does not reopen; working Production date is **Monday 2026-09-14**</li></ul> | **High** |
